...
public class UsuariosController {
    ...
    public ResponseEntity<UsuarioResponse> editarNome(@Valid @RequestBody EditarNomeUsuarioRequest editarNomeUsuarioRequest, @PathVariable Long id) {

        return ResponseEntity.status(HttpStatus.OK).body(usuariosService.editarNomeUsuario(editarNomeUsuarioRequest, id));
    }

    @PatchMapping("/{id}/email")
    public ResponseEntity<UsuarioResponse> editarEmail(@Valid @RequestBody EditarEmailUsuarioRequest editarEmailUsuarioRequest, @PathVariable Long id) {

        return ResponseEntity.status(HttpStatus.OK).body(usuariosService.editarEmailUsuario(editarEmailUsuarioRequest, id));
    }

    @PatchMapping("/{id}/senha")
    public ResponseEntity<UsuarioResponse> editarSenha(@Valid @RequestBody EditarSenhaUsuarioRequest editarSenhaUsuarioRequest, @PathVariable Long id) {
